...
public interface QuestionRepository extends JpaRepository<AptitudeQuestion, Long> {
    //책 목차 id로 문제 조회하기
    Page<AptitudeQuestion> findQuestionByBookContentId(Long bookContentId, Pageable pageable);
    ...
    Page<AptitudeQuestion> findQuestionByBookId(@Param("bookId") Long bookId, Pageable pageable);

    //문제 id로 문제 조회하기
    AptitudeQuestion findQuestionById(Long id);
}
