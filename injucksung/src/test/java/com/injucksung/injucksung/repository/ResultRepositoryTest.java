...
public class ResultRepositoryTest {
    ...
    public void resultid로_해당Category_조회하기() throws Exception {
        System.out.println(resultRepository.findResultById(1L).getQuestion().getQuestionCategory());
    }
    ...
    public void categoryId와quizRecordId로_Result_목록_조회하기() throws Exception {
        ...
        print(resultByCategoryIdAndQuizRecordId);
    }
